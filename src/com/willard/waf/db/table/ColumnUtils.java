...
import com.willard.waf.db.annotation.Check;
import com.willard.waf.db.annotation.Column;
import com.willard.waf.db.annotation.Finder;
import com.willard.waf.db.annotation.Foreign;
import com.willard.waf.db.annotation.Id;
import com.willard.waf.db.annotation.NotNull;
import com.willard.waf.db.annotation.Transient;
import com.willard.waf.db.annotation.Unique;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(com.willard.waf.db.table.Foreign foreignColumn) {
    ...
    /**
     * 获取泛型的实际类型
     * 如FinderLazyLoader<T> public FinderLazyLoader<Child> children;
     * 则返回Child的类型
     * @param finderColumn
     * @return
     */
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.willard.waf.db.table.Finder finderColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Object convert2DbColumnValueIfNeeded(final Object value) {//仅仅只是对值的转换
        Object result = value;
        if (value != null) {
