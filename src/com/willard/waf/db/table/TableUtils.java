...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.willard.waf.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.willard.waf.db.table.Id>();

    /* package */
    static synchronized com.willard.waf.db.table.Id getId(Class<?> entityType) {
        ...
        com.willard.waf.db.table.Id id = new com.willard.waf.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
    	com.willard.waf.db.table.Id id = getId(entityType);
