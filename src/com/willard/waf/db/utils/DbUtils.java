...
package com.willard.waf.db.utils;
...
import com.willard.waf.db.sqlite.CursorUtils;
import com.willard.waf.db.sqlite.DbModelSelector;
import com.willard.waf.db.sqlite.Selector;
import com.willard.waf.db.sqlite.SqlInfo;
import com.willard.waf.db.sqlite.SqlInfoBuilder;
import com.willard.waf.db.sqlite.WhereBuilder;
import com.willard.waf.db.table.DbModel;
import com.willard.waf.db.table.Id;
import com.willard.waf.db.table.Table;
import com.willard.waf.db.table.TableUtils;
...
public class DbUtils {
    ...
    private void beginTransaction() {
        if (allowTransaction) {
            database.beginTransaction();//事务的开启会自动锁定DB
        } else {
            writeLock.lock();
            writeLocked = true;
        }
...
//		}
    ...
    private class FindTempCache {
         ...
         * key: sql;
         * value: find result
         * HashMap是不支持并发的，不是线程安全的 而ConcurrentHashMap支持并发且线程安全
         */
        ...
        public void setSeq(long seq) {
            ...
            /**
				cache缓存数据 格式{sql=data}
				{SELECT * FROM parent WHERE id in (1,3,6) LIMIT 1 OFFSET 0=Parent{id=1, name='测试1431053380199', email='wyouflf@gmail.com', isAdmin=true, time=Fri May 08 10:49:40 格林尼治标准时间+0800 2015, date=2015-05-08}}
             */
        }
    }
